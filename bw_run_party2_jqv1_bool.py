...
sudo tc qdisc add dev ens5 root handle 1: tbf rate 10Mbit latency 5ms burst 1000k 
'''
print(ban)
subprocess.call(["bash", "-c", ban])
JQv1_bool = '''
./JQv1/bin/test_bool_circuit_scalability 2 12345 172.31.27.9
'''
print(JQv1_bool)
subprocess.call(["bash", "-c", JQv1_bool])

JQv2_bool = '''
./JQv2/bin/test_bool_ostriple  2 12345 172.31.27.9
'''
print(JQv2_bool)
...
ban = '''
sudo tc qdisc del dev ens5 root
sudo tc qdisc add dev ens5 root handle 1: tbf rate 15Mbit latency 5ms burst 1500k 
'''
print(ban)
subprocess.call(["bash", "-c", ban])
JQv1_bool = '''
