...
void test_compute_and_gate_check_huge_random_circuit_JQv2(FpOSTriple<NetIO> *os, int len, int repeat) {
...
void test_ostriple(NetIO *ios[threads + 1], int party, int len, int repeat) {
  ...
  test_compute_and_gate_check_huge_random_circuit_JQv2(&os, len, repeat);
}
